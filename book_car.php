		...
		<div class="wrapper">
			...
			?>
				...
				<form method="post">
					<table>
						<tr>
							<td style="background-color:#FF0000">Full Name:</td>
							<td><input type="text" name="fname" required></td>
						</tr>
						<tr>
							<td style="background-color:#FF0000">Phone Number:</td>
							<td><input type="text" name="phone" required></td>
						</tr>
						<tr>
							<td style="background-color:#FF0000">Email Address:</td>
							<td><input type="email" name="email" required></td>
						</tr>
						<tr>
							<td style="background-color:#FF0000">ID Number:</td>
							<td><input type="text" name="id_no" required></td>
						</tr>
						<tr>
							<td style="background-color:#FF0000">Gender:</td>
							<td>
								<select name="gender">
						...
						<tr>
							<td style="background-color:#FF0000">Location:</td>
