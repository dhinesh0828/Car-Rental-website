	...
	<section class="search">
		<div class="wrapper">
			<form action="#" method="post">
				<input type="text" id="search" style="background-color:#000000" name="search" placeholder="What are you looking for?"  autocomplete="off"/>
		...
		<div class="wrapper">
			<ul class="properties_list">
				...
				<form method="post">
					<table>
						<tr>
							<td style="background-color:#FF0000">MPESA Transaction ID:</td>
							<td><input type="text" name="mpesa" required></td>
						</tr>
						<tr>
							<td style="background-color:#FF0000">National ID Number:</td>
